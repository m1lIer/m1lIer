...
**🛍 Outvue** — [outvue.me](https://outvue.me)

Fashion-соцсеть: пользователи собирают образы, получают ML-рекомендации, переходят на покупку в маркетплейсы.

`React Three Fiber` `GSAP` `Node.js` `PostgreSQL` `ML recommendations`

</td>
<td width="50%" valign="top">

**📚 dnnd.one** — [dnnd.one](https://dnnd.one)

Платформа для репетиторов: календарь, свободные слоты в часовых поясах, оплата, домашние задания.

`Next.js` `Fastify` `Drizzle ORM` `PostgreSQL`
